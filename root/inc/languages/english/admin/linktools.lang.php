...
$l['lkt_can_manage_link_listings'] = 'Can import, view, and classify (as spam) links?';
$l['lkt_linklisting_and_import'] = 'Link Listing and Import';
...
$l['lkt_import_links'] = 'Import Links';
$l['lkt_import_links_desc'] = 'Provide a list of links to be imported, one per line.';
$l['lkt_url'] = 'Link (URL)';
...
$l['lkt_spam_classification'        ] = 'Spam classification';
$l['lkt_spam_classification_desc'   ] = 'Choose how to classify the imported links';
$l['lkt_override_policy'            ] = 'Override policy';
$l['lkt_override_policy_desc'       ] = 'Choose what to do when an imported link already exists';
$l['lkt_override_policy_override'   ] = 'Reclassify the link unconditionally';
$l['lkt_override_policy_conditional'] = 'Reclassify the link only if it is currently classified as \'Unspecified\' or \'Potential spam\'';
$l['lkt_override_policy_ignore'     ] = 'Do not reclassify the link';
$l['lkt_links_to_import'            ] = 'Links (URLs) to import';
$l['lkt_links_to_import_desc'       ] = 'Provide one link per line';
$l['lkt_err_invalid_urls'           ] = 'One or more of the provided links (URLs) was found to be invalid. Please ensure that all links are valid before retrying:';
$l['lkt_err_invalid_spam_class'     ] = 'The supplied spam classification, "{1}", is invalid.';
$l['lkt_err_invalid_override_policy'] = 'The supplied override policy, "{1}", is invalid.';
$l['lkt_import_urls_success'        ] = 'Successfully imported the links (URLs)';
