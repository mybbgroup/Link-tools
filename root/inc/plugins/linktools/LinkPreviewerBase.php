...
abstract class LinkPreviewer {
	 ...
	 * supported by this Previewer. This is the preferred regex, since
	 * matching non-normalised links may result in different previewers
	 * being prioritised highest for URLs which are all the same in the
	 * sense of normalising to the same normalised URL.
	 */
	protected $supported_norm_links_regex;

	/**
	 * The alternative regex against which a link is tested to determine
	 * whether or not it is supported by this Previewer if the regex above
	 * for normalised URLs is not set.
	 */
	protected $supported_links_regex;

	/**
	 * This Previewer's priority as a candidate to generate the preview for
	...
	/**
	 * This Previewer's version, used to determine whether a link preview
	 * generated by this Previewer is still valid (i.e., was generated by
	 * the Previewer with the same version number).
	 *
	 * Also used to determine when this Previewer's template needs to be
	 ...
	 * MyBB when this Link Previewer is enabled in the ACP. If it is empty,
	 * the call to $this->get_template_for_eval() will return the contents
	 * of the 'linktools_linkpreview_default' template. If it is not empty,
	 * it will be named 'linktools_linkpreview_' followed by the lowercased
	 * class name with the "LinkPreviewer" prefix removed.
	 *
	 ...
	 * IF it is possible that Link Previewers which DO need content might
	 * after content is downloaded end up supporting the content at a
	 * higher priority.
	 */
	const NC_NEVER_AND_FINAL = 1;
	/**
	 * The page's content (or content type) is necessary for this Previewer
	 * to determine whether it supports previews for a given page.
	 */
	const NC_FOR_SUPPORT     = 2;
	/**
	 * The page's content (or content type) is necessary for this Previewer
	 * to generate a preview for the pages it supports.
	 */
	const NC_FOR_GEN_PV      = 4;
	/**
	 * The page's content (or content type) is necessary both for this
	 * Previewer to determine whether it supports previews for a given page,
	 * as well as to generate a preview for the pages it supports.
	 */
	const NC_FOR_BOTH        = self::NC_FOR_SUPPORT | self::NC_FOR_GEN_PV;

	/**
	 * The scenarios in which this Previewer requires the page's content
	 * type and/or content.
	 */
	 ...
	 * Generally, Previewers which set $needs_content_for to NC_NEVER or to
	...
	/**
	 * Tests whether the given link is supported by this Previewer.
	 *
	 * For Previewers for which $needs_content_for & NC_FOR_SUPPORT is true,
	 * this is only a provisional value; the final value is provided by
	 * supports_page().
	 *
	...
	/**
	 * Tests whether this Previewer supports the page at the URL $link with
	...
	/**
	 * Gets this Previewer's $needs_content_for property.
	 *
	 * @return integer This Previewer's $needs_content_for property.
	 */
	...
	/**
	 * Gets this Previewer's $should_cache_preview property.
	 *
	 * @return boolean This Previewer's $should_cache_preview property.
	 */
	...
	/**
	 * Gets this Previewer's priority.
	 *
	 * @return integer This Previewer's priority.
	 */
	...
	/**
	 * Gets this Previewer's version number.
	 *
	...
	/**
	 * Gets this Previewer's friendly name.
	 *
	...
	/**
	 * Gets the name of the template this Previewer uses for its output.
	 *
	 ...
	 * if/when a Previewer which descends from this base class is enabled
	 * at admin/index.php?module=config-linkpreviewers.
	 *
	...
	/**
	 * Gets the template this Previewer uses for its output, the contents of
